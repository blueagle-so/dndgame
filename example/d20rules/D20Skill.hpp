...
namespace D20Rules
{
	namespace Rollables
	{
		...
		public:
			...
			D20Skill(const bool bNewUsedUntrained, const bool bNewRetry, const bool bNewArmorCheckPenality, const std::string sNewName, const Definitions::RelatedModifier rmNewModifierName);
